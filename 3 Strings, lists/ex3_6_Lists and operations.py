...
print(marks[0])
print(marks[1])
avmrk = (marks[0] + marks[1] + marks[2] + marks[3] + marks[4] + marks[5])/6
print(avmrk)
...
# Task 10
# map(str, input().split()) - удаляет все пробелы между элементами
# map(str, input().split(" ")) - удаляет по одному пробелу между элементами
...
# использовать срез с отрицательным шагом - нет
# отсортировать, затем объединить получившийся список - да
a = 'привет'
print(a[::-1])
